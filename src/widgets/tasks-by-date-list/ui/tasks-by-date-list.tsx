...
import { getTasksByUser } from '../lib/utils';
import { UsersSelector } from '../../../entities/users-selector';
...
export const TasksByDateList = (): React.ReactElement => {
  const [currentUser, tasks] = useUnit([$currentUser, $tasks]);
  ...
  const { filteredByDateTasks } = getTasksDataByDate(selectedPeriod, tasks);
